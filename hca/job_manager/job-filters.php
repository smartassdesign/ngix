...
<div class="row">
  <div class="col-sm-6">
		<div class="search_keywords">
			...
			<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php _e( 'Search for Jobs', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" class="form-control" />
		</div>
</div> <!-- /.col-sm-6 -->
<div class="col-sm-6">		
		...
		<div class="search_location">
			...
			<input type="text" name="search_location" id="search_location" placeholder="<?php _e( 'Search by Location', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $location ); ?>" class="form-control" />
		</div>
</div> <!-- /.col-sm-6 -->
</div> <!-- /.row -->
</div> <!-- /.form-group -->
