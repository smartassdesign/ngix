<?php
/**
 * NGI OVERRIDE of the... (conceivably just to get it in a container... we'll see)
...
<div id="tribe-events-bar">
	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_attr( $current_url ); ?>">
		...
		<?php if ( count( $views ) > 1 ) { ?>
			<div id="tribe-bar-views" class="col-md-2">
			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<input class="tribe-events-button tribe-no-param btn btn-sm" type="submit" name="submit-bar" value="<?php printf( __( 'Find %s', 'tribe-events-calendar' ), tribe_get_event_label_plural() ); ?>" />
					</div>
					<!-- .tribe-bar-submit -->
				</div>
